...
export interface ReplanResponse {
  ...
  plans: {
    id: string;
    strategy: "preserve_booking" | "maximize_attractions" | "relaxed";
    title: string;
    items: TripItem[];
    explanation: string;
  }[];
